...
class TestAuthRouter:
    ...
    async def test_register_duplicate_email(self, client, sample_user_data, created_user):
    ...
    async def test_register_weak_password_too_short(self, client, sample_user_data):
        ...
        assert response.status_code == status.HTTP_422_UNPROCESSABLE_ENTITY
        data = response.json()
        assert any("at least 8 characters" in str(error["message"]) for error in data["error"]["details"]["validation_errors"])

    async def test_register_weak_password_no_uppercase(self, client, sample_user_data):
        ...
        assert response.status_code == status.HTTP_422_UNPROCESSABLE_ENTITY
        data = response.json()
        assert any("uppercase letter" in str(error["message"]) for error in data["error"]["details"]["validation_errors"])

    async def test_register_weak_password_no_lowercase(self, client, sample_user_data):
        ...
        assert response.status_code == status.HTTP_422_UNPROCESSABLE_ENTITY
        data = response.json()
        assert any("lowercase letter" in str(error["message"]) for error in data["error"]["details"]["validation_errors"])

    async def test_register_weak_password_no_number(self, client, sample_user_data):
        ...
        assert response.status_code == status.HTTP_422_UNPROCESSABLE_ENTITY
        data = response.json()
        assert any("number" in str(error["message"]) for error in data["error"]["details"]["validation_errors"])

    async def test_register_strong_password_success(self, client, sample_user_data):
    ...
    async def test_login_success(self, client, sample_user_data, created_user):
    ...
    async def test_login_wrong_email(self, client, sample_user_data, created_user):
    ...
    async def test_login_wrong_password(self, client, sample_user_data, created_user):
    ...
    async def test_change_password_success(self, client, auth_headers, sample_user_data):
...
class TestAuthRouterValidation:
    ...
    async def test_register_invalid_email_formats(self, client, sample_user_data):
    ...
    async def test_register_long_names(self, client, sample_user_data):
        ...
        response = await client.post("/api/v1/auth/register", json=long_data)
...
class TestAuthRouterSecurity:
    ...
    async def test_password_not_returned_in_responses(self, client, sample_user_data):
    ...
    async def test_token_expiration_handling(self, client, auth_service, created_user):
